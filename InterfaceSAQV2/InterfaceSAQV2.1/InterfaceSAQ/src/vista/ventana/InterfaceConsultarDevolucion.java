...
import static vista.ventana.InterfaceConsultarPrestamo.ObtenerFecha;
import static vista.ventana.InterfaceConsultarPrestamo.ObtenerHora;
import static vista.ventana.InterfaceRegistrarMatyEqu.integerFormat;


public class InterfaceConsultarDevolucion extends javax.swing.JFrame {

    String fechaActual, horaActual;
    
    public InterfaceConsultarDevolucion() {
        initComponents();
        this.setTitle("SAQ - Consulta Devolucion Mat. y Equipos");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jDateChooser1, new org.netbeans.lib.awtextra.AbsoluteConstraints(207, 70, 230, 30));

        lblFecha.setFont(new java.awt.Font("Arial Narrow", 1, 18)); // NOI18N
        lblFecha.setForeground(new java.awt.Color(0, 255, 255));
        getContentPane().add(lblFecha, new org.netbeans.lib.awtextra.AbsoluteConstraints(129, 11, 90, 30));
        ...
        jLabel4.setText("ID Devolucion:");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 70, -1, 30));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfaceConsultarDevolucion.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InterfaceConsultarDevolucion().setVisible(true);
            }
        });
    }
